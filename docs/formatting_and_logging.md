...
|----------|---------|-------------|
| `ROMPY_LOG_LEVEL` | `INFO` | Minimum log level (DEBUG, INFO, WARNING, ERROR, CRITICAL) |
| `ROMPY_LOG_FORMAT` | `detailed` | Log format style (`simple` or `detailed`) |
| `ROMPY_LOG_FILE` | None | Optional file path for log output |
