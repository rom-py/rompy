...
def test_schism_container_basic_config(tmp_path):
    ...
    from rompy.schism.data import SCHISMData, SCHISMDataBoundaryConditions, BoundarySetupWithSource
...
def test_swan_container_basic_config(tmp_path):
    ...
    from rompy.swan.components.boundary import INITIAL, BOUNDSPEC
    from rompy.swan.components.group import INPGRIDS, OUTPUT, LOCKUP
    ...
    from rompy.swan.components.physics import GEN3, BREAKING_CONSTANT, FRICTION_MADSEN
    from rompy.swan.subcomponents.readgrid import GRIDREGULAR
    from rompy.swan.subcomponents.spectrum import SPECTRUM, SHAPESPEC, PM
    from rompy.swan.subcomponents.startup import SPHERICAL
    from rompy.swan.subcomponents.boundary import DEFAULT,  SIDE, CONSTANTPAR
